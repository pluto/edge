...
//! commitment engine We require the commitment engine to provide a commitment
//! to vectors with a single group element
use core::{
  fmt::Debug,
...
/// Note this does not impose any memory representation constraints on the
/// structure.
pub trait Len {
