...
impl<E: Engine> R1CSShapeSparkRepr<E> {
    ...
    pub fn new(S: &R1CSShape<E>) -> Self {
        ...
        let timestamp_calc =
            |num_ops: usize, num_cells: usize, addr_trace: &[usize]| -> Vec<usize> {
...
impl<E: Engine, EE: EvaluationEngineTrait<E>> RelaxedR1CSSNARKTrait<E> for RelaxedR1CSSNARK<E, EE> {
    ...
    fn initialize_pk(ck: Arc<CommitmentKey<E>>, vk_digest: <E as Engine>::Scalar) -> Result<Self::ProverKey, NovaError> {
    ...
    fn prove(
        ...
        let ((mut outer_sc_inst, mut inner_sc_inst), mem_res) = rayon::join(
            ...
            || {
                ...
                let poly_eq =
                    MultilinearPolynomial::new(PowPolynomial::new(&rho, num_rounds_sc).evals());
        ...
        let w: PolyEvalWitness<E> = PolyEvalWitness::batch(&poly_vec, &c);
        let u: PolyEvalInstance<E> =
            PolyEvalInstance::batch(&comm_vec, rand_sc.clone(), &eval_vec, &c);
        ...
        let claim_sc_final_expected = {
            ...
            let claim_outer_final_expected = coeffs[6]
                ...
                * (self.eval_Az * self.eval_Bz - U.u * self.eval_Cz - self.eval_E)
                + coeffs[7]
                    * taus_bound_rand_sc
                    * (self.eval_Az + c * self.eval_Bz + c * c * self.eval_Cz);
